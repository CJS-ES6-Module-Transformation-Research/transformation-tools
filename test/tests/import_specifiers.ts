...
describe('import_specifiers', () => {
	...
	// 	const project = createProject(join(FIXTURES, 'import_specifiers/single_named__named'), true)
	...
	// 	const project = createProject(join(FIXTURES, 'import_specifiers/single_named__default'), false)
	...
	// 	const project = createProject(join(FIXTURES, 'import_specifiers/default_with_copy__named'), true)
