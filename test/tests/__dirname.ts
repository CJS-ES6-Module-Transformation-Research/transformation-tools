...
describe('__dirname', () => {
	...
	it('filename_only_preexisting_url', () => {
		const project = createProject(join(TEST_DIR, 'test_data/__dirname/filename_only_preexisting_url'), false)
	...
	it('filename_only_new_url_require', () => {
		const project = createProject(join(TEST_DIR, 'test_data/__dirname/filename_only_new_url_require'), false)
	...
	it('dirname_only_preexisting_path', () => {
		const project = createProject(join(TEST_DIR, 'test_data/__dirname/dirname_only_preexisting_path'), false)
	...
	it('dirname_only_new_path_require', () => {
		const project = createProject(join(TEST_DIR, 'test_data/__dirname/dirname_only_new_path_require'), false)
	...
	it('both_dirname_filename', () => {
		const project = createProject(join(TEST_DIR, 'test_data/__dirname/both_dirname_filename'), false)
	...
	it('dirname_in_if', () => {
		const project = createProject(join(TEST_DIR, 'test_data/__dirname/dirname_in_if'), false)
	...
	it('dirname_in_callexpr', () => {
		const project = createProject(join(TEST_DIR, 'test_data/__dirname/dirname_in_callexpr'), false)
	...
	it('dirname_in_newexpr', () => {
		const project = createProject(join(TEST_DIR, 'test_data/__dirname/dirname_in_newexpr'), false)
