...
describe('json_require', () => {
	...
	it('parallel_json_require', () => {
		const project = createProject(TEST_DIR+'/test_data/json_require/parallel_json_require', false)
	...
	it('up_one_json_require', () => {
		const project = createProject( TEST_DIR+'/test_data/json_require/up_one_json_require', false)
	...
	it('down_one_json_require', () => {
		const project = createProject(TEST_DIR+'/test_data/json_require/down_one_json_require', false)
	...
	it('multi_json_require_same_mid', () => {
		const project = createProject(TEST_DIR+'/test_data/json_require/multi_json_require_same_mid', false)
	...
	it('js_has_priority', () => {
		const project = createProject(TEST_DIR+'/test_data/json_require/js_has_priority', false)
