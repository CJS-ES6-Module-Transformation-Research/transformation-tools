...
const _moduleAccess_chownr = require('chownr');
const _moduleAccess_tar_stream = require('tar-stream');
const _moduleAccess_pump = require('pump');
const _moduleAccess_mkdirp = require('mkdirp');
