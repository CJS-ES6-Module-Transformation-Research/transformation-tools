...
var strip = function (map, level) {
    return function (header) {
        header.name = header.alias.split('/').slice(level).join('/');
...
exports.extract = function (cwd, opts) {
    ...
    extract.on('entry', function (header, stream, next) {
        header = map(header) || header;
        header.alias = normalize(header.alias);
        var name = path.join(cwd, path.join('/', header.alias));
...
export const extract = exports.extract;
export const pack = exports.pack
