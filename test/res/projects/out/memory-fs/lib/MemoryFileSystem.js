...
'use strict';
const _moduleAccess___normalize = require('./normalize.js');
const _moduleAccess___join = require('./join.js');
const _moduleAccess___MemoryFileSystemError = require('./MemoryFileSystemError.js');
const _moduleAccess_errno = require('errno');
const _moduleAccess_readable_stream = require('readable-stream');
