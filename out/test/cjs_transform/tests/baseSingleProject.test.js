...
var project;
var projstr = index_2.project + "/test/res/fixtures/test_dir";
...
describe('Testing various sanitize procedures', function () {
    ...
    mocha_1.it('VariableDeclaration Flattening', function () {
        //flattenDecls
        var inputProjectDir = index_2.project + "/test/res/actual/flattenActual/";
    ...
    mocha_1.it('Access Replacement', function () {
        //AccessReplace
        var actualProj = src_1.projectReader(index_2.project + "/test/res/actual/accessReplace");
    ...
    mocha_1.it('Import Transformations', function () {
        //AccessReplace
        var actualProj = src_1.projectReader(index_2.project + "/test/res/actual/importTransform");
        var expectedProj = src_1.projectReader(index_2.project + "/test/res/expected/imports", 'module');
        var listOfFiles = ['index.js', 'lib/index.js', 'lib.js', 'src/index.js', 'test/default.test.js'];
        var transformer = Transformer_1.Transformer.ofProject(actualProj);
        transformer.transform(src_1.accessReplace);
