...
describe('Testing various sanitize procedures', () => {
    ...
    it('Access Replacement', () => {
        //AccessReplace
        let actualProj: TransformableProject = projectReader(`${PROJ_DIR}/test/res/actual/accessReplace`)
    ...
    it('Import Transformations', () => {
        ...
        let actualProj: TransformableProject = projectReader(`${PROJ_DIR}/test/res/actual/importTransform`)

        let expectedProj: TransformableProject = projectReader(`${PROJ_DIR}/test/res/expected/imports`, 'module');
