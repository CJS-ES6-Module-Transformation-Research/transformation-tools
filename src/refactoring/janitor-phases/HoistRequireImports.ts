...
import {declare, id, isARequire, asRequire, RequireCall} from "../../utility";
import {NodeComparators} from "../static-analysis";
        ...
        enter: (node: Node, parent: Node) => {
            ...
            if (node.type === "VariableDeclaration"
                ...
                if (parent.type === "Program") {
                    ...
                    variableRenameMapping.push({
                        old: node.declarations[0].id.name,
                        new: id2.name,
                        scope: node[NodeComparators.Scope_ID]
                    });
