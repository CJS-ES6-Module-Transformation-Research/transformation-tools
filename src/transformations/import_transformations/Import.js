...
var Import = /** @class */ (function () {
    function Import(importString, imports, isDefault) {
    ...
    Import.prototype.getImportString = function () {
        return this.importString;
    };
    Import.prototype.getImports = function () {
        return this.imports;
    };
    Import.prototype.getImportType = function () {
