...
exports.DEFAULT_EXPORT_STRING = '__default_export';
            ...
            if (node.type === "AssignmentExpression") {
                ...
                if (child.type === "MemberExpression"
                    ...
                    var anExp = {
                        ...
                        expr: node.right,
                        isNamed: false,
                        alias: node.right.type === "Identifier" ? node.right.name : exports.DEFAULT_EXPORT_STRING,
                        identifier: node.right.type === "Identifier" ? node.right.name : exports.DEFAULT_EXPORT_STRING,
...
var ExprType;
(function (ExprType) {
    ExprType["EXPR"] = "Expression";
    ExprType["IDENTIFIER"] = "Identifier";
    ExprType["OBJECT"] = "ObjectExpression";
    ExprType["SIMPLE_EXPR"] = "Expression";
    ExprType["DECL"] = "Declaration";
    ExprType["OTHER"] = "Other";
})(ExprType || (ExprType = {}));
var exportKV = { names: [], hasDefault: false };
var defaultVisitor = {
    enter: function (node, parent) {
        ...
        enter: function (node, parent) {
            ...
            if (node.type === "AssignmentExpression") {
                ...
                if (child.type === "MemberExpression"
                    ...
                    var defstring = node.right.type === "Identifier" ? node.right.name : exports.DEFAULT_EXPORT_STRING;
                    // return createAnExport(anExp);
                    default_ = {
