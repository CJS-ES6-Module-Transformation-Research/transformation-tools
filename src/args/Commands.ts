...
import {write_status as op_type} from "../abstract_fs_v2/interfaces";
...
function getPMOptsFromYargs(cwd: string) {
	...
	function setOpts(args: yargs.Arguments<ProgramArgs>) {
		toReturnPMOpts.input = args.input as string
	}
}
